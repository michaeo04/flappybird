...
#tao list may cai ong de biet no xuat hien
def create_pipe():
...
def score_display(game_state):
    ...
    if game_state == 'game over':
        ...
        high_score_rect = score_surface.get_rect(center = (169,610))
...
high_score = 0
game_active = True
#tao trong luc de con chim luon bi keo xuong
gravity = 0.25
bird_movement = 0
#chen background  
bg = pygame.image.load("assets/background_night.png").convert()
...
#tao cai hinh vuong quanh con chim de biet va cham
bird_rect = bird.get_rect(center = (100,384))
#tao timer cho bird
birdflap = pygame.USEREVENT + 1
pygame.time.set_timer(birdflap,200)
#tao vong lap cho cai ong
...
pipe_height = [150,200,250,275,300,325,350,375,400,425,450,500]
#tao man hinh ket thuc
game_over_surface = pygame.transform.scale2x(pygame.image.load('assets/message.png')).convert_alpha()
game_over_rect = game_over_surface.get_rect(center = (216,350))
#chen am thanh
flap_sound = pygame.mixer.Sound('sound/sfx_wing.wav')
crush_sound = pygame.mixer.Sound('sound/sfx_hit.wav')
...
while True:
    ...
    draw_floor()
    if floor_x_pos <= -432:
        floor_x_pos = 0 #vong lap 2 cai san
